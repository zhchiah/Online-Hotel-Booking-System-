    ...
    <main>
        ...
        $database = 'finalproject';
           ...
           $conn = new mysqli($host, $username, "", $database);
            ...
            if (isset($_GET['id'])) {
                $room_id = $_GET['id'];
                $sql = "SELECT * FROM room WHERE hotel = $room_id";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<a href='room.php?id=".$row['id']."'> <img src='images/" . $row['picture'] . "' class='card-img-top'    style='height:300px;width:350px;' alt='Room Image'> </a>";
                    ...
                    echo "<p class='card-text'>" . $row["type"] . "</p>";
                     ...
                     echo"<a href='book.php?id=".$row['id']."'> <button>Book Now </button></a>";
                    ...
                    echo "No hotel found with ID: $room_id";
                }
            } else {
